            ...
            <div className="fields-group view-plan">
              ...
              <div className="ui-box bzt-info-area">
                ...
                <div className="item-field">
                  ...
                  <dl className="txt-data">HD12341123</dl>
                </div>
              ...
              <div className="ui-box">
                ...
                <div className="item-field">
                  <div className="txt-data">일비 신청</div>
                  <div className="txt-data">직원 숙소 신청</div>
                </div>
                <div className="item-field">
                  <Link to="#">
                    규정집 보기
              ...
              {/* modify: file-form-area */}
              <div className="ui-box file-form-area">
                <div className="inner-sides">
                  <div className="left-area">
                    <Typography variant="h3" className="bp-title">
                      첨부문서
                ...
                <div className="item-field">
                  <div className="bp-file file-formType">
                ...
                <div className="item-field">
                  <div className="bp-file file-imageType">
                    <div className="file-btnType">
                      <input
                        ref={fileInputRef3}
                        type="file"
